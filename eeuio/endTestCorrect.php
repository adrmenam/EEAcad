<?php
  ...
  $sql = "UPDATE EVAXUSU SET EXU_FIN=1 , EXU_RESULTADO=1, EXU_OBSERVACION='APROBADO'
  WHERE TIE_CODIGO=2 AND EVA_CODIGO=1 AND 
...
<div class="page-container">
  ...
  <div class="main-container">
    ...
    <div id="startDiv" style="padding-top:150px;">
	 	<h2>FELICIDADES, HA COMPLETADO LA EVALUACIÓN CORRECTAMENTE!</h2>

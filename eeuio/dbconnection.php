<?php
  ...
  //consultas
    ...
    $select_tools="SELECT *FROM HERRAMIENTA ORDER BY HER_NOMBRE LIMIT 5";
    ...
    WHERE E.EVA_CODIGO=EU.EVA_CODIGO AND U.USU_CODIGO=EU.USU_CODIGO AND T.TIE_CODIGO=EU.TIE_CODIGO';

  ...
  <div class="page-sidebar">
		...
		echo "<li ><a href='users.php'><i class='icon-users'></i><span class='title'>Usuarios</span></a>";
          //echo '<li ><a href="toolsMenu.php"><i class="icon-tools"></i><span class="title">Evaluación</span></a> ';
    			...
    			echo     '<li class="active"><a href="evaluation.php"><i class="icon-newspaper"></i><span class="title">Resultados de Evaluaciones</span></a></li>';
    			echo '</li>';
		?>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form id="resetpassword" method="post" action="resetpassword.php">
                      ...
                      <input type="text" maxlength="10" class="form-control" id="id" name="id" placeholder="ID" value="'.$row->USU_CODIGO.'">
                       ...
                       <input type="text" class="form-control" id="name" name="name" placeholder="Nombre completo" disabled value="'.$row->USU_NOMBRES.' '.$row->USU_APELLIDOS.'">
                       </div>

                       <div class="form-group">
                       <label for="password">Contraseña Nueva</label>
                       <input type="password" class="form-control" id="password" name="password" placeholder="Escriba la nueva contraseña">
                       </div>
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" form="resetpassword" class="btn btn-primary">Guardar</button>
                  </div>
                </div><!-- /.modal-content -->
              </div><!-- /.modal-dialog -->

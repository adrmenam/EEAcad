...
lib.ssMetadata = [
		{name:"VestimentaAvatar_atlas_", frames: [[1922,0,1920,1080],[0,0,1920,1080],[5766,0,1920,1080],[1922,1082,1920,1080],[0,1082,1920,1080],[0,3246,1920,1080],[3844,1082,1920,1080],[5766,1082,1920,1080],[3844,0,1920,1080],[0,2164,1920,1080],[3844,3246,1920,1080],[5766,3246,1920,1080],[0,4328,1920,1080],[0,5410,1920,1080],[0,6492,1920,1080],[1922,2164,1920,1080],[3844,2164,1920,1080],[5766,2164,1920,1080],[1922,3246,1920,1080],[5766,6492,1920,1080],[1922,4328,1920,1080],[3844,6492,1920,1080],[1922,5410,1920,1080],[1922,6492,1920,1080],[3844,4328,1920,1080],[5766,4328,1920,1080],[3844,5410,1920,1080],[5766,5410,1920,1080]]},
		{name:"VestimentaAvatar_atlas_2", frames: [[1368,4532,1366,768],[0,4625,1366,768],[5619,3718,1366,768],[3136,4489,1366,768],[5055,4488,1366,768],[3687,3719,1366,768],[6423,4488,1366,768],[1768,3762,1366,768],[0,3855,1366,768],[2736,5259,1366,768],[4504,5258,1366,768],[1368,5302,1366,768],[0,5395,1366,768],[5872,5258,1366,768],[0,7076,530,398],[2736,4532,233,457],[4104,6798,841,904],[4504,4489,512,512],[3136,3762,523,717],[4947,7187,1355,204],[1767,7179,1355,204],[7688,1616,274,1079],[4947,6798,1667,387],[3193,6799,662,417],[6987,3718,756,549],[7240,5258,756,549],[2736,4991,330,240],[6987,4269,398,125],[6840,6028,1280,720],[4104,6028,1366,768],[2736,6029,1366,768],[5472,6028,1366,768],[2238,6072,400,400],[7791,4829,288,364],[7688,808,451,806],[7688,0,451,806],[5055,3719,538,752],[0,3246,1766,607],[5764,2941,1919,775],[5764,2164,1919,775],[1922,2164,1919,922],[3843,2164,1919,873],[7964,1616,178,294],[8084,2076,72,187],[7964,2076,118,141],[7964,1912,202,162],[1922,3088,1763,672],[3843,3039,1774,678],[1922,1082,1920,1080],[5766,0,1920,1080],[0,0,1920,1080],[3844,0,1920,1080],[1922,0,1920,1080],[7791,3976,233,851],[7745,3439,422,535],[7685,2697,373,740],[2238,6799,953,378],[6840,6750,846,904],[0,6165,844,909],[1368,6072,868,901],[3124,7218,613,253],[846,6975,919,309],[0,1082,1920,1080],[1368,3855,303,642],[3844,1082,1920,1080],[5766,1082,1920,1080],[0,2164,1920,1080]]}
];
...
(lib.VestimentaAvatar = function(mode,startPosition,loop) {
	...
	this.text = new cjs.Text("Varilla", "37px 'Times New Roman'");
	this.text.lineHeight = 43;
	this.text.lineWidth = 272;
	this.text.alpha = 0.80784314;
	this.text.parent = this;
	this.text.setTransform(1612.2,1005.1);
	...
	this.text_1 = new cjs.Text("Extremo Varilla", "37px 'Times New Roman'");
	this.text_1.lineHeight = 43;
	this.text_1.lineWidth = 272;
	this.text_1.alpha = 0.80784314;
	this.text_1.parent = this;
	this.text_1.setTransform(1602,546.5);
	...
	this.text_2 = new cjs.Text("Extremo Camión", "37px 'Times New Roman'");
	this.text_2.lineHeight = 43;
	this.text_2.lineWidth = 272;
	this.text_2.alpha = 0.80784314;
	this.text_2.parent = this;
	this.text_2.setTransform(1602,295.6);
	...
	this.text_3 = new cjs.Text("HERRAMIENTAS", "52px 'Times New Roman'");
	this.text_3.lineHeight = 60;
	this.text_3.lineWidth = 416;
	this.text_3.alpha = 0.80784314;
	this.text_3.parent = this;
	this.text_3.setTransform(1467.7,30);
	...
	this.text_4 = new cjs.Text("Arnés", "37px 'Times New Roman'");
	this.text_4.lineHeight = 43;
	this.text_4.lineWidth = 272;
	this.text_4.alpha = 0.80784314;
	this.text_4.parent = this;
	this.text_4.setTransform(1655.2,153.7);
	...
	this.objective058.setTransform(1536.1,462.2,2.006,27.382,0,78.6,49.8,69.4,30.3);

	this.cobertor058 = new lib.Cobertor_79();
	this.cobertor058.name = "cobertor058";
	this.cobertor058.parent = this;
	this.cobertor058.setTransform(1491.1,491.6,1.389,1.419,0,0,0,683.2,383.8);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.shape,p:{scaleX:2.73,x:1690.4,y:567.7}},{t:this.text_3,p:{x:1467.7,y:30,text:"HERRAMIENTAS",font:"52px 'Times New Roman'",lineHeight:59.6,lineWidth:416}},{t:this.pinzaDer001},{t:this.text_2,p:{x:1602,y:295.6,text:"Extremo Camión",lineWidth:272}},{t:this.pinzaIzq001},{t:this.text_1,p:{x:1602,y:546.5,text:"Extremo Varilla",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:272,scaleX:1}},{t:this.varilla001},{t:this.text,p:{x:1612.2,y:1005.1,text:"Varilla",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:272,color:"#000000",scaleX:1}},{t:this.objective001}]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.instance_1},{t:this.objective002},{t:this.shape,p:{scaleX:2.73,x:1690.4,y:567.7}},{t:this.pinzaDer002},{t:this.text_2,p:{x:1616.1,y:328.6,text:"Extremo Camión",lineWidth:272}},{t:this.pinzaIzq002},{t:this.text_1,p:{x:1616.1,y:614.4,text:"Extremo Varilla",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:272,scaleX:1}},{t:this.text,p:{x:1487.1,y:28,text:"HERRAMIENTAS",font:"52px 'Times New Roman'",lineHeight:59.6,lineWidth:416,color:"#000000",scaleX:1}}]},1).to({state:[{t:this.instance_2},{t:this.objective003},{t:this.shape,p:{scaleX:2.73,x:1690.4,y:567.7}},{t:this.text_1,p:{x:1488.5,y:19.2,text:"HERRAMIENTAS",font:"52px 'Times New Roman'",lineHeight:59.6,lineWidth:416,scaleX:1}},{t:this.pinzaDer003},{t:this.text,p:{x:1577.2,y:569.9,text:"Extremo Camión",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:272,color:"#000000",scaleX:1}}]},1).to({state:[{t:this.instance_3},{t:this.shape,p:{scaleX:2.73,x:1690.4,y:567.7}},{t:this.btnNext004}]},1).to({state:[{t:this.objective005},{t:this.instance_4},{t:this.shape,p:{scaleX:3.45,x:1638.8,y:522}},{t:this.arnes005},{t:this.text_4},{t:this.text_3,p:{x:1379.6,y:461.5,text:"Casco",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:272}},{t:this.text_2,p:{x:1390.6,y:588.9,text:"Mangas",lineWidth:272}},{t:this.guantes005},{t:this.text_1,p:{x:1543.3,y:865,text:"Guantes",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:272,scaleX:1}},{t:this.mangas005},{t:this.casco005},{t:this.text,p:{x:1450.3,y:40,text:"HERRAMIENTAS",font:"52px 'Times New Roman'",lineHeight:59.6,lineWidth:416,color:"#000000",scaleX:1}}]},1).to({state:[{t:this.text_3,p:{x:1546.5,y:895.1,text:"Guantes",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:272}},{t:this.text_2,p:{x:1548.9,y:573.6,text:"Mangas",lineWidth:272}},{t:this.instance_5},{t:this.objective006},{t:this.casco006},{t:this.text_1,p:{x:1518.6,y:245.3,text:"Casco",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:272,scaleX:1}},{t:this.guantes006},{t:this.mangas006},{t:this.text,p:{x:1419.6,y:30,text:"HERRAMIENTAS",font:"52px 'Times New Roman'",lineHeight:59.6,lineWidth:416,color:"#000000",scaleX:1}}]},1).to({state:[{t:this.text_2,p:{x:1541,y:754.6,text:"Guantes",lineWidth:272}},{t:this.text_1,p:{x:1523.5,y:337,text:"Casco",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:272,scaleX:1}},{t:this.instance_6},{t:this.objective007},{t:this.casco007},{t:this.guantes007},{t:this.text,p:{x:1396.5,y:30,text:"HERRAMIENTAS",font:"52px 'Times New Roman'",lineHeight:59.6,lineWidth:416,color:"#000000",scaleX:1}}]},1).to({state:[{t:this.text_1,p:{x:1518.6,y:378.4,text:"Casco",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:272,scaleX:1}},{t:this.instance_7},{t:this.objective008},{t:this.casco008},{t:this.text,p:{x:1401.2,y:30,text:"HERRAMIENTAS",font:"52px 'Times New Roman'",lineHeight:59.6,lineWidth:416,color:"#000000",scaleX:1}}]},1).to({state:[{t:this.instance_8},{t:this.btnNext009}]},1).to({state:[{t:this.cobertor010},{t:this.objective010},{t:this.text,p:{x:1564.2,y:426.1,text:"Cobertor",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:272,color:"#000000",scaleX:1}}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.objective012},{t:this.pinza012},{t:this.text_1,p:{x:1592.8,y:638.4,text:"Pinza",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:272,scaleX:1}},{t:this.text,p:{x:1592.8,y:322.3,text:"Manta",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:272,color:"#000000",scaleX:1}},{t:this.manta012}]},1).to({state:[{t:this.objective013},{t:this.pinza013},{t:this.text,p:{x:1585.7,y:423.3,text:"Pinza",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:272,color:"#000000",scaleX:1}}]},1).to({state:[{t:this.objective03}]},1).to({state:[{t:this.text_2,p:{x:1597.3,y:985.6,text:"Cobertor",lineWidth:143}},{t:this.cobertor015},{t:this.objective015},{t:this.text_1,p:{x:469.2,y:1019.6,text:"Manta",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:143,scaleX:1}},{t:this.text,p:{x:135.1,y:994.1,text:"Pinza",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:143,color:"#000000",scaleX:1}},{t:this.soporte015},{t:this.manta015},{t:this.pinza015}]},1).to({state:[{t:this.text_2,p:{x:1589.6,y:983.6,text:"Cobertor",lineWidth:143}},{t:this.cobertor016},{t:this.text_1,p:{x:462.4,y:1019.3,text:"Manta",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:143,scaleX:1}},{t:this.text,p:{x:127.3,y:994.1,text:"Pinza",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:143,color:"#000000",scaleX:1}},{t:this.soporte016},{t:this.manta016},{t:this.pinza016},{t:this.objective016}]},1).to({state:[{t:this.text_2,p:{x:1589.6,y:983.6,text:"Cobertor",lineWidth:143}},{t:this.cobertor017},{t:this.text_1,p:{x:462.4,y:1019.3,text:"Manta",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:143,scaleX:1}},{t:this.text,p:{x:127.3,y:994.1,text:"Pinza",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:143,color:"#000000",scaleX:1}},{t:this.soporte017},{t:this.manta017},{t:this.objective017},{t:this.pinza017}]},1).to({state:[{t:this.text_1,p:{x:462.4,y:1019.3,text:"Manta",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:143,scaleX:1}},{t:this.text,p:{x:127.3,y:994.1,text:"Pinza",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:143,color:"#000000",scaleX:1}},{t:this.soporte018},{t:this.manta018},{t:this.objective018},{t:this.pinza018}]},1).to({state:[{t:this.text_1,p:{x:462.4,y:1019.3,text:"Manta",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:143,scaleX:1}},{t:this.text,p:{x:127.3,y:994.1,text:"Pinza",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:143,color:"#000000",scaleX:1}},{t:this.manta019},{t:this.objective3},{t:this.pinza019},{t:this.objective019}]},1).to({state:[{t:this.text,p:{x:127.3,y:994.1,text:"Pinza",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:143,color:"#000000",scaleX:1}},{t:this.objective3},{t:this.pinza020},{t:this.objective020}]},1).to({state:[]},1).to({state:[{t:this.objective022},{t:this.soportePoste022},{t:this.text,p:{x:876.4,y:863.3,text:"Soporte Temporal de Poste",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:421,color:"#000000",scaleX:1}}]},1).to({state:[{t:this.soportePoste023},{t:this.objective023},{t:this.text,p:{x:871.3,y:879.5,text:"Soporte Temporal de Poste",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:421,color:"#000000",scaleX:1}}]},1).to({state:[]},1).to({state:[{t:this.cobertor025},{t:this.text,p:{x:607.5,y:849.9,text:"ARRASTRE LA PIEZA QUE SE DEBE RETIRAR",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:826,color:"#FFFFFF",scaleX:1}}]},1).to({state:[{t:this.cobertor026a},{t:this.cobertor026b},{t:this.text,p:{x:696.4,y:851,text:"SELECCIONE LA PIEZA QUE SE DEBE RETIRAR",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:826,color:"#FFFFFF",scaleX:1}}]},1).to({state:[{t:this.manta027},{t:this.objective027},{t:this.text,p:{x:530.5,y:841.9,text:"Manta y pinza",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:229,color:"#000000",scaleX:0.803}}]},1).to({state:[]},1).to({state:[{t:this.amarre029},{t:this.objective029}]},1).to({state:[{t:this.cobertor030a},{t:this.cobertor030b}]},1).to({state:[{t:this.objective031}]},1).to({state:[]},1).to({state:[{t:this.manta033},{t:this.pinza033},{t:this.objective033}]},1).to({state:[{t:this.pinza034},{t:this.objective034}]},1).to({state:[{t:this.objective035},{t:this.manta035}]},1).to({state:[{t:this.objective036},{t:this.aislador036}]},1).to({state:[]},1).to({state:[{t:this.cruceta038},{t:this.objective038}]},1).to({state:[]},1).to({state:[{t:this.crucetaDoble040},{t:this.objective040}]},1).to({state:[]},1).to({state:[{t:this.aislantePolimerico042},{t:this.pistolas042},{t:this.objective042},{t:this.text_1,p:{x:1452.1,y:867.7,text:"Pistolas",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:144,scaleX:1}},{t:this.text,p:{x:964.7,y:851,text:"Aislante Polimerico",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:318,color:"#000000",scaleX:1}}]},1).to({state:[{t:this.pistolas043},{t:this.objective043},{t:this.text,p:{x:1212.6,y:858,text:"Pistolas",font:"37px 'Times New Roman'",lineHeight:42.95,lineWidth:136,color:"#000000",scaleX:1}}]},1).to({state:[]},1).to({state:[{t:this.cobertor045}]},1).to({state:[{t:this.unia046},{t:this.objective046}]},1).to({state:[]},1).to({state:[{t:this.objective048},{t:this.estribo048}]},1).to({state:[]},1).to({state:[{t:this.text_1,p:{x:517.2,y:828.8,text:"PUENTE",font:"40px 'Times New Roman'",lineHeight:46.3,lineWidth:229,scaleX:0.986}},{t:this.puente050},{t:this.soporteTempCruceta050},{t:this.text,p:{x:1115.2,y:828.8,text:"SOPORTE TEMP. CRUCETA",font:"40px 'Times New Roman'",lineHeight:46.3,lineWidth:307,color:"#000000",scaleX:0.986}},{t:this.objective050}]},1).to({state:[{t:this.text,p:{x:653.9,y:932.4,text:"PUENTE",font:"40px 'Times New Roman'",lineHeight:46.3,lineWidth:229,color:"#000000",scaleX:0.986}},{t:this.puente051}]},1).to({state:[]},1).to({state:[{t:this.objective053}]},1).to({state:[{t:this.manta054},{t:this.text,p:{x:1033.7,y:946.4,text:"MANTA",font:"45px 'Times New Roman'",lineHeight:51.85,lineWidth:200,color:"#000000",scaleX:0.982}}]},1).to({state:[{t:this.text,p:{x:1078.8,y:940.9,text:"MANTA",font:"45px 'Times New Roman'",lineHeight:51.85,lineWidth:200,color:"#000000",scaleX:0.982}},{t:this.manta055},{t:this.objective055}]},1).to({state:[]},1).to({state:[{t:this.objective057}]},1).to({state:[{t:this.cobertor058},{t:this.objective058}]},1).to({state:[]},1).to({state:[{t:this.cableMetalico060},{t:this.objective060}]},1).to({state:[{t:this.objective061},{t:this.pertiga061}]},1).to({state:[]},1).to({state:[{t:this.unia063},{t:this.objective063}]},1).to({state:[{t:this.text,p:{x:938.3,y:935.8,text:"MANTA CON PINZA",font:"45px 'Times New Roman'",lineHeight:51.85,lineWidth:288,color:"#000000",scaleX:0.982}},{t:this.mantaPinza064},{t:this.objective064}]},1).to({state:[]},1).wait(1));
	...
	this.text_5.setTransform(1509.5,41.9,0.982,1);
	...
	this.text_6 = new cjs.Text("Manta", "37px 'Times New Roman'");
	this.text_6.lineHeight = 43;
	this.text_6.lineWidth = 119;
	this.text_6.alpha = 0.80784314;
	this.text_6.parent = this;
	this.text_6.setTransform(553,846.4);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.btnNextJ1},{t:this.text_5}]},9).to({state:[{t:this.btnNext011},{t:this.text_5}]},1).to({state:[{t:this.text_5}]},1).to({state:[{t:this.text_5}]},1).to({state:[{t:this.btnNext014}]},1).to({state:[]},1).to({state:[{t:this.btnNext021}]},6).to({state:[]},1).to({state:[{t:this.btnNext024}]},2).to({state:[{t:this.objective025}]},1).to({state:[]},1).to({state:[{t:this.btnNext028}]},2).to({state:[{t:this.text_5}]},1).to({state:[{t:this.text_5}]},1).to({state:[{t:this.text_5}]},1).to({state:[{t:this.btnNext032}]},1).to({state:[{t:this.text_6,p:{x:553,y:846.4,text:"Manta",lineWidth:119}},{t:this.text_5}]},1).to({state:[{t:this.text_5}]},1).to({state:[{t:this.text_5}]},1).to({state:[{t:this.text_5}]},1).to({state:[{t:this.btnNext037}]},1).to({state:[{t:this.text_5}]},1).to({state:[{t:this.btnNext039}]},1).to({state:[{t:this.text_5}]},1).to({state:[{t:this.btnNext041}]},1).to({state:[]},1).to({state:[{t:this.btnNext044}]},2).to({state:[]},1).to({state:[{t:this.text_6,p:{x:979,y:863.8,text:"Uña",lineWidth:80}},{t:this.text_5}]},1).to({state:[{t:this.btnNext047}]},1).to({state:[{t:this.text_6,p:{x:905.9,y:853,text:"Tecle de Faja",lineWidth:220}},{t:this.text_5}]},1).to({state:[{t:this.btnNext049}]},1).to({state:[]},1).to({state:[{t:this.btnNext052}]},2).to({state:[]},1).to({state:[{t:this.text_5}]},1).to({state:[{t:this.text_5}]},1).to({state:[{t:this.btnNext056}]},1).to({state:[]},1).to({state:[{t:this.btnNext059}]},2).to({state:[]},1).to({state:[{t:this.btnNext062}]},2).to({state:[]},1).to({state:[{t:this.btnNext065}]},2).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.text_5).wait(9).to({_off:false},0).wait(1).to({x:1510.1,y:41.7},0).wait(1).to({x:1509.6,y:39.7},0).wait(1).to({y:45.5},0).to({_off:true},1).wait(15).to({_off:false,scaleX:1,x:656.9,y:854.5,text:"ARRASTRE LA PIEZA QUE SE DEBE RETIRAR",font:"37px 'Times New Roman'",color:"#FFFFFF",lineHeight:43,lineWidth:826},0).wait(1).to({x:657.4,y:851.6,text:"SELECCIONE LA PIEZA QUE SE DEBE MOVERSE",lineWidth:864},0).wait(1).to({x:566.1,text:"ARRASTRE LA LINEA A SU POSICION CORRECTA"},0).to({_off:true},1).wait(1).to({_off:false,x:1253.8,y:846.4,text:"Pinza",color:"#000000",lineWidth:106},0).wait(1).to({x:726.6,y:856},0).wait(1).to({x:639.1,y:846.2,text:"ARRASTRE LA PIEZA QUE SE DEBE RETIRAR",color:"#FFFFFF",lineWidth:826},0).wait(1).to({x:661.5,y:855.1},0).to({_off:true},1).wait(1).to({_off:false,x:609.1,y:834.1},0).to({_off:true},1).wait(1).to({_off:false,x:525.1,y:865,text:"Cruceta Doble",color:"#000000",lineWidth:119},0).to({_off:true},1).wait(5).to({_off:false,x:56,y:903.4,text:"HERRAMIENTAS",font:"52px 'Times New Roman'",lineHeight:59.6,lineWidth:416},0).to({_off:true},1).wait(1).to({_off:false,x:60.9,y:922.1},0).to({_off:true},1).wait(5).to({_off:false,x:42.4,y:931.1},0).wait(1).to({x:49.8},0).to({_off:true},1).wait(10));
	...
	this.text_7.setTransform(876.4,829.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_3}]},5).to({state:[{t:this.shape_3}]},4).to({state:[{t:this.shape_3},{t:this.text_7,p:{x:876.4,y:829.6}}]},5).to({state:[{t:this.shape_3}]},6).to({state:[{t:this.shape_3},{t:this.text_7,p:{x:35,y:911.6}}]},1).to({state:[{t:this.shape_3}]},2).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_3},{t:this.text_7,p:{x:43.8,y:929.8}}]},2).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_3}]},3).to({state:[{t:this.shape_3},{t:this.text_7,p:{x:33.9,y:923}}]},1).to({state:[{t:this.shape_3}]},2).to({state:[{t:this.shape_3}]},2).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_3},{t:this.text_7,p:{x:43.7,y:928}}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_3},{t:this.text_7,p:{x:46.3,y:920.1}}]},1).to({state:[{t:this.shape_3}]},2).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_3}]},2).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_3},{t:this.text_7,p:{x:31.6,y:913.8}}]},1).to({state:[{t:this.shape_3}]},2).to({state:[]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_3}]},2).to({state:[]},1).to({state:[{t:this.shape_3},{t:this.text_7,p:{x:32.5,y:935.8}}]},7).to({state:[]},1).wait(1));
	...
	this.text_8 = new cjs.Text("SELECCIONE LA PIEZA QUE SE DEBE RETIRAR", "37px 'Times New Roman'", "#FFFFFF");
	this.text_8.lineHeight = 43;
	this.text_8.lineWidth = 826;
	this.text_8.alpha = 0.80784314;
	this.text_8.parent = this;
	this.text_8.setTransform(525.4,849.9);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/VestimentaAvatar_atlas_T.png?1527656264235", id:"VestimentaAvatar_atlas_"},
		{src:"images/VestimentaAvatar_atlas_2_T.png?1527656264239", id:"VestimentaAvatar_atlas_2"}
	],
	preloads: []
};

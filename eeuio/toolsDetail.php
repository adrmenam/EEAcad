...
<div class="page-container">
  ...
  <div class="page-sidebar">
		...
		<ul id="side-nav" class="main-menu navbar-collapse collapse">
			...
			<li class="has-sub active"><a href="panels.html"><i class="icon-newspaper"></i><span class="title">UI Elements</span></a>
				<ul class="nav">
					...
					<li class="active"><a href="modals.html"><span class="title">Modals</span></a></li>
  ...
  <div class="main-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li class="active"><strong>Modals</strong></li> 
		</ol>
		<div class="row">
			<div class="col-lg-12 animatedParent animateOnce z-index-50">
				<div class="panel panel-default animated fadeInUp">
					<div class="panel-heading clearfix"> 
						<h3 class="panel-title">Modals</h3> 
					...
					<div class="panel-body">
						...
						<hr><p><strong>Large Modal</strong></p> 
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-2">Show me</button>
						<hr>
						<p><strong>Small Modal</strong></p> 
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-3">Show me</button>
					</div> 
				 </div>
			 </div>
		 </div>	
